...
def extract_negative_patches(subdir, n4bfc_bet_angio_path, bids_dataset_path, desired_spacing, out_dataset_path, mni_landmark_points_path, intensity_thresholds,
    ...
    if lesions:  # if list is not empty --> we're dealing with a patient with one or more aneurysm(s)
        ...
        seed_ext = extract_vessel_like_neg_patches(nb_vessel_like_patches_per_sub, angio_min_x, angio_max_x, angio_min_y, angio_max_y, angio_min_z, angio_max_z, shift_scale_1,
